...
class reportClass:
    def __init__(self, root):
        ...
        btn_search = Button(self.root, text="Search", font=("goudy old style", 10, "bold"), bg="#4caf50", fg="white", cursor="hand2",command=self.search).place(x=690, y=100, width=100,height=35)
        btn_clear = Button(self.root, text="Clear", font=("goudy old style", 10, "bold"), bg="gray", fg="white", cursor="hand2",command=self.clear).place(x=800, y=100, width=100,height=35)
        ...
        lbl_marks=Label(self.root,text="Mark's Obtained",font=("goudy old style",15,"bold"),bg="white",bd=2,relief=GROOVE).place(x=600,y=230,width=150,height=50)
        ...
        ################### delete #################################
        btn_delete = Button(self.root, text="Delete", font=("goudy old style", 10, "bold"), bg="red", fg="white", cursor="hand2",command=self.delete).place(x=500, y=350, width=150,height=35)
    ...
    def search(self):
                ...
                try:
                    if self.var_search.get()=="":
                        messagebox.showerror('Error',"roll no should be requried",parent=self.root)
                    else:
                        ...
                        if row != None:
                            ...
                            messagebox.showerror("Info", "please fill the result first", parent=self.root)
                except Exception as ex:
                    messagebox.showerror("Error", "please fill the result first" ,parent=self.root)
                finally:
                    con.close()
        ...
        try:
            if self.var_id == "":
                ...
                if row is None:
                    ...
                    if op:  # Executes only if the user selects "Yes"
